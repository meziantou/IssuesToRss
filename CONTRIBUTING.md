...
Please read these guidelines before contributing to meziantou/IssuesToRss:
...
If you have questions about how to use meziantou/IssuesToRss, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/IssuesToRss's existing code formatting and naming standard
- Run meziantou/IssuesToRss's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/IssuesToRss you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
